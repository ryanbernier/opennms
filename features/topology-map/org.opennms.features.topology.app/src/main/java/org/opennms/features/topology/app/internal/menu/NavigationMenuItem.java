...
public class NavigationMenuItem extends AbstractMenuItem {
    ...
    public MenuCommand getCommand() {
        return (targets, operationContext) -> {
            // add menu items for the "navigate to" operation
            ...
            final List<VertexRef> targetVertices = oppositeVertices.stream()
                    .filter(v -> v.getNamespace().matches(targetGraphProvider.getVertexNamespace()))
            ...
            breadcrumbCriteria.setNewRoot(sourceVertex, targetGraphProvider.getVertexNamespace());
