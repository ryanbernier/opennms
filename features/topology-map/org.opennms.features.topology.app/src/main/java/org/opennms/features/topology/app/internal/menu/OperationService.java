...
/**
 * Helper object to encapsulate the registerec {@link Operation} with it's service properties, as this is
...
public class OperationService {
    ...
    public OperationService(Operation operation, Map<String, String> props) {
